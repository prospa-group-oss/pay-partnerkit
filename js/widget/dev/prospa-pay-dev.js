...
(function() {  
    ...
    function showPrice () {
            ...
            if (itemPrice >= minPrice && itemPrice <= 20000){
                ...
                prospaPayOffer = '<span id="prospa-pay-offer"><span id="prospa-pay-offer-prefix">or <span id="prospa-pay-instalment" style="font-weight:bolder"> $' + prospaPayWeeklyPrice + ' per week </span><span id="prospa-pay-term">over ' + prospaPayTerm + ' weeks.</span></span> <span id="prospa-pay-more-info"><a id="prospa-pay-modal-link" href="#prospa-pay-modal" style="text-decoration:none; color:#38B973">Prospa&nbsp;Pay&nbsp;for&nbsp;business.</a></span></span>';
